          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="q in quarterlyData" :key="q.quarter">
                ...
                <td>
                  ${{
                    q.total_revenue.toLocaleString("en-US", {
                ...
                <td>
                  ${{
                    q.avg_order_value.toLocaleString("en-US", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })
                  }}
...
export default {
  ...
  setup() {
    ...
    // maxRevenue computed once so getBarHeight doesn't recalculate it on every call
